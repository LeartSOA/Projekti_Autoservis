...
import autoservisi.Autoservisi.MakinaIme.activities.ViewVehicleActivity;
...
public class VehicleRecyclerViewAdapter extends
    ...
    public void onItemSwipedDismiss(final int position) {
        ...
        String text = vehicle.getType() + " " + vehicle.getName() + " u fshi";
        Snackbar snackbar = Snackbar.make(viewForSnackbar, text, Snackbar.LENGTH_LONG);
        snackbar.setAction("Kthehu", new View.OnClickListener() {
            @Override
            public void onClick(View view) {
