...
import autoservisi.Autoservisi.MakinaIme.utils.ChartUtils;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                LineDataSet servicesDataSet = new LineDataSet(entries, "Riparimet");
                ...
                LineDataSet iDataSet = new LineDataSet(iEntries, "Sigurimet");
                ...
                LineDataSet rDataSet = new LineDataSet(rEntries, "Mbushjet");
                ...
                LineDataSet eDataSet = new LineDataSet(eEntries, "Shpenzimet");
