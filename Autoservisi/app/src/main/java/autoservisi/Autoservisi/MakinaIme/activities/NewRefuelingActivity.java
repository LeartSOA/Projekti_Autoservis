...
public class NewRefuelingActivity extends NewBaseActivity {
    ...
    protected void onItemSaved() {
        if (isNewItem()) {
            showMessage("Mbushja e re u shtua");
        }else {
            showMessage("Mbushja u rifreskua");
